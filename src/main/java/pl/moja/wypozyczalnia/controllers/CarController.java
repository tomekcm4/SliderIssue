...
//		 int i = Integer.parseInt(basepriceTextField.getText());
//			
//
...
//		  {
//		  
//		  priceTextField.textProperty().setValue( String.valueOf((int)
//		  daysSlider.getValue()* i ));
//		  
//		  
//		  }
//		  
//		  });
		...
		priceTextField.textProperty().addListener(new ChangeListener() {
			...
			public void changed(ObservableValue arg0, Object arg1, Object arg2) {
				...
				baseCost.add(Integer.parseInt(basepriceTextField.getText()));
			}
		});
	...
	public void bindings() {
		...
		this.basepriceTextField.textProperty().bindBidirectional(this.carModel.getCarFxObjectProperty().basepriceProperty(),
				new NumberStringConverter());
